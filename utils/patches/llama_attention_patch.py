...
# borrowed from https://github.com/dvlab-research/LongLoRA/blob/main/llama_attn_replace_sft.py  # noqa
...
def forward_flashattn(
    ...
    if not self.training:
        warnings.warn(
            "This function should be used just for training as it may "
            "exhibit reduced inference performance. For inference, "
            "please use forward_flashattn_inference."
        )
...
def patch_llama_attn(use_flash_attn=True, use_full=False, inference=False):
    if use_flash_attn:
